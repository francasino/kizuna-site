const COURSE_DATA = {
  ...
  "slides": [
    {
      "module_id": 0,
      "slide_num_str": "Diapositiva 0A",
      "title": "Portada del Módulo 0",
      "visual_title": "Bienvenida al Programa",
      "text_on_screen": [
        "• Módulo 0: Introducción, Metodología y Aval Normativo",
        "• Empieza aquí tu formación en Prevención de Riesgos Digitales"
      ],
      "extended_text": [
        "\"Antes de comenzar, este bloque introductorio te explicará la metodología del curso, el mapa de módulos, el aval normativo del programa y el glosario de conceptos clave que usaremos a lo largo del camino.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    },
    {
      ...
      "text_on_screen": [
        "• Bienvenida y Objetivos: Bienvenido al programa de capacitación integral en Prevención de Riesgos Digitales.",
        ...
        "• Enfoque Práctico: Este no es un curso técnico sobre informática; es un programa sobre decisiones diarias, comportamiento, ética digital y cumplimiento legal."
      ],
      "extended_text": [
        "\"Bienvenidos.",
    ...
    {
      "module_id": 1,
      "slide_num_str": "Diapositiva 1A",
      "title": "Portada del Módulo 1",
      "visual_title": "Identidad Digital y Validez Jurídica",
      "text_on_screen": [
        "• Módulo 1: Identidad Digital y Validez Jurídica",
        "• El fin de la contraseña compartida y el peso legal de tu firma digital"
      ],
      "extended_text": [
        "\"En este módulo aprenderás por qué tu identidad digital es tu firma legal en el mundo corporativo, qué implica el estándar eIDAS 2.0 y por qué compartir credenciales puede acarrearte responsabilidades penales. También conocerás la MFA, tu escudo más efectivo.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    {
      "module_id": 1,
      "slide_num_str": "Diapositiva 6b",
      "title": "La Cartera Digital Europea (EUDI Wallet)",
      "visual_title": "Caso Práctico: Tu Identidad en un solo lugar",
      "text_on_screen": [
        "• eIDAS 2.0 y la EUDI Wallet: La Unión Europea introduce una cartera digital única en tu teléfono móvil para gestionar tu identidad con total seguridad y control de tus datos.",
        "• Control de Atributos: Tú decides qué información compartir (edad, titulación, DNI) sin revelar datos innecesarios.",
        "• Firma Integrada: La cartera permite realizar Firmas Electrónicas Cualificadas de forma nativa con el mismo valor legal que tu firma manuscrita."
      ],
      "extended_text": [
        "\"Con la llegada del reglamento eIDAS 2.0, el modelo tradicional de identificación sufrirá un cambio drástico. La Cartera de Identidad Digital Europea (EUDI Wallet) no es solo una app para guardar tu DNI digital; es una infraestructura segura que permite al ciudadano autenticarse en servicios públicos y privados de toda Europa con pleno control de sus datos.",
        "Imagina que vas a alquilar un coche: en lugar de dejar que le hagan fotocopias a tu DNI físico, la cartera digital enviará únicamente un certificado criptográfico que demuestra que tienes más de 18 años y una licencia de conducir válida, ocultando el resto de tus datos personales.",
    ...
    },
    {
      ...
      "visual_title": "",
      "text_on_screen": [
        "• Requisito Legal (NIS2): El MFA (Autenticación de Múltiples Factores) es una medida técnica obligatoria para proteger las cuentas organizativas.",
        "• Los Tres Factores: Requiere combinar al menos dos factores distintos: algo que sabes (contraseña), algo que tienes (móvil) o algo que eres (huella).",
        "• El Nuevo Riesgo (MFA Bombing): Si recibes peticiones repetidas de aprobación de acceso que tú no has iniciado, NO las apruebes. Es un ataque y debes reportarlo."
      ],
      "extended_text": [
    ...
    {
      "module_id": 2,
      "slide_num_str": "Diapositiva 2A",
      "title": "Portada del Módulo 2",
      "visual_title": "Psicología del Ataque y Shadow AI",
      "text_on_screen": [
        "• Módulo 2: Psicología del Ataque y Shadow AI",
        "• Cómo hackean tu mente y el peligro de las IAs públicas"
      ],
      "extended_text": [
        "\"Los cibercriminales no solo atacan máquinas; atacan mentes. En este módulo descubrirás los perfiles psicológicos del Modelo OCEAN, cómo tus propios rasgos de personalidad pueden convertirte en un vector de ataque, y el grave riesgo que supone el Shadow AI para la confidencialidad de la empresa.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    {
      "module_id": 2,
      "slide_num_str": "Diapositiva 18A",
      "title": "El Cuestionario (Bloque A)",
      "visual_title": "Cuestionario de Comportamiento Digital (Bloque A / 5)",
      "text_on_screen": [
      ...
      "extended_text": [
        "\"El Bloque A mide tu nivel de complacencia. Ser servicial es maravilloso, pero en ciberseguridad, el exceso de confianza es la vía principal del Phishing. Si la mayoría de tus respuestas en este bloque son SÍ, eres el blanco perfecto para el Spear Phishing, ya que tu deseo de complacer te impide cuestionar solicitudes urgentes.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    {
      "module_id": 2,
      "slide_num_str": "Diapositiva 18B",
      "title": "El Cuestionario (Bloque B)",
      "visual_title": "Cuestionario de Comportamiento Digital (Bloque B / 5)",
      "text_on_screen": [
      ...
      "extended_text": [
        "\"El Bloque B mide la falta de minuciosidad o impulsividad. La prisa y la multitarea son los mayores enemigos de la atención plena; cuando tu cerebro está saturado, automatiza el acto de hacer clic sin analizar el peligro. Los delincuentes envían anzuelos cotidianos: multas, alertas bancarias o avisos de paquetes para capturar a usuarios en modo piloto automático.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    {
      "module_id": 2,
      "slide_num_str": "Diapositiva 19A",
      "title": "El Cuestionario (Bloque C)",
      "visual_title": "Cuestionario de Comportamiento Digital (Bloque C / 5)",
      "text_on_screen": [
      ...
      "extended_text": [
        "\"El Bloque C evalúa tu reactividad ante el estrés. Los ataques conocidos como 'Fraude del CEO' se basan en esto: generan un pánico artificial para que te saltes los protocolos por miedo a un castigo. Si la mayoría de tus SÍ corresponden a este bloque, tienes una alta sensibilidad al estrés y debes recordar que el protocolo de seguridad está siempre por encima de la jerarquía o la urgencia.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    {
      "module_id": 2,
      "slide_num_str": "Diapositiva 19B",
      "title": "El Cuestionario (Bloque D)",
      "visual_title": "Cuestionario de Comportamiento Digital (Bloque D / 5)",
      "text_on_screen": [
      ...
      "extended_text": [
        "\"El Bloque D evalúa la curiosidad y la temeridad. Los usuarios más innovadores y adaptables a menudo caen en la trampa de usar software no autorizado para ser más eficientes, creando fugas de datos sin darse cuenta. Si tu perfil es Temerario, recuerda el principio Zero Trust: en ciberseguridad, nadie es inmune al engaño, ni siquiera los expertos.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    },
    {
      ...
      "title": "El Cuestionario (Bloque E)",
      "visual_title": "Cuestionario de Comportamiento Digital (Bloque E / 5)",
      "text_on_screen": [
      ...
      "extended_text": [
        "\"El Bloque E evalúa tu nivel de exposición digital. Las redes sociales son la herramienta de reconocimiento más poderosa de un atacante. Publicar información sobre proyectos, clientes o el entorno de trabajo da ventaja al adversario en la fase de reconocimiento de la Cyber Kill Chain. Aplica el Escudo de Privacidad: antes de publicar cualquier foto o información corporativa, análiza si podría ser útil para un atacante.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    {
      "module_id": 2,
      "slide_num_str": "Diapositiva 20B",
      "title": "Diagnóstico de Perfil OCEAN",
      "visual_title": "Tu Diagnóstico de Vulnerabilidad Digital",
      "text_on_screen": [
        "• DIAGNÓSTICO: Suma el total de tus respuestas SÍ por bloque y compara con los perfiles de riesgo.",
        "• Perfil A - Complaciente: Mayoría de SÍ en Bloque A → Vulnerable al Spear Phishing y suplantación de identidad.",
        "• Perfil B - Impulsivo: Mayoría de SÍ en Bloque B → Vulnerable al clic irreflexivo y las facturas falsas.",
        "• Perfil C - Ansioso: Mayoría de SÍ en Bloque C → Vulnerable al Fraude del CEO e intimidación psicológica.",
        "• Perfil D - Temerario: Mayoría de SÍ en Bloque D → Vulnerable al Shadow IT y la arrogancia cognitiva.",
        "• Perfil E - Expuesto: Mayoría de SÍ en Bloque E → Vulnerable al reconocimiento OSINT y el oversharing."
      ],
      "extended_text": [],
      "image_desc": null,
      "image_file": null,
    ...
    },
    {
      ...
      "visual_title": "",
      "text_on_screen": [
        "• Tu Riesgo (Spear Phishing): Tu deseo de no incomodar o complacer a superiores y clientes te impide cuestionar solicitudes. Eres el blanco perfecto para la suplantación de identidad.",
        "• Comportamiento Típico: Acatar órdenes urgentes sin verificar el remitente por vergüenza a parecer descortés o retrasar un trámite.",
        "• Tu Regla de Oro: La Desconfianza Educada. Verificar la identidad llamando por teléfono no es una falta de respeto, es un deber legal y profesional."
      ],
      "extended_text": [
        "\"El perfil complaciente destaca por su alta amabilidad y empatía. En el día a día, esto facilita el trabajo en equipo, pero en ciberseguridad es una debilidad crítica. Los atacantes se aprovechan de tu tendencia natural a complacer y evitar conflictos. Si recibes un correo supuestamente de un directivo exigiéndote enviar una base de datos confidencial en 10 minutos bajo la excusa de una reunión de urgencia, tu instinto será obedecer de inmediato. Tienes miedo de parecer desobediente o mal educado si llamas para confirmar. Recuerda: verificar un remitente a través de un canal secundario (como una llamada de teléfono o un mensaje de Teams) no es de mala educación, sino que demuestra un alto compromiso profesional con la seguridad corporativa.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    },
    {
      ...
      "visual_title": "",
      "text_on_screen": [
        "• Tu Riesgo (Piloto Automático): La velocidad anula tu capacidad de análisis. Al trabajar de forma impulsiva, caes en trampas rutinarias como adjuntos de facturas falsas.",
        "• Comportamiento Típico: Hacer clic en enlaces o descargar archivos en correos de mensajería (UPS, correos) sin prestar atención a los detalles de seguridad.",
        "• Tu Regla de Oro: La Pausa de los 10 Segundos. Separa las manos del teclado antes de abrir cualquier enlace o archivo inesperado para analizar los detalles."
      ],
      "extended_text": [
        "\"El perfil impulsivo se caracteriza por una baja responsabilidad en la atención sostenida. En un entorno laboral acelerado, con múltiples notificaciones sonando simultáneamente, este perfil trabaja en 'piloto automático'. Los delincuentes envían anzuelos impersonales pero cotidianos: multas de tráfico falsas, alertas bancarias de seguridad o avisos de entregas de paquetes inexistentes. Al no pausar a reflexionar, el usuario impulsivo hace clic antes de pensar. La Regla de Oro de los 10 segundos obliga a detener la acción física, mirar la dirección real del remitente, revisar si hay faltas gramaticales generadas por traducción automática y comprobar si realmente esperas esa comunicación.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    },
    {
      ...
      "visual_title": "",
      "text_on_screen": [
        "• Tu Riesgo (Bloqueo e Intimidación): El miedo a represalias te paraliza, haciéndote vulnerable a extorsiones, multas falsas o al Fraude del CEO. Tiendes a ocultar los errores por vergüenza.",
        "• Comportamiento Típico: Ceder a amenazas de sanciones legales urgentes o presiones psicológicas que simulan ser del director general de la empresa.",
        "• Tu Regla de Oro: El Protocolo vence a la Jerarquía. Las normas de seguridad están por encima de las órdenes urgentes. Reportar los errores a tiempo nos salva; ocultarlos nos hunde."
      ],
      "extended_text": [
        "\"El perfil ansioso presenta una alta sensibilidad al estrés y al miedo al conflicto o castigo. Los ciberdelincuentes utilizan la intimidación psicológica como herramienta principal. Envían correos con logotipos de juzgados, la Policía Nacional o directivos de la propia corporación con mensajes alarmantes como 'Tu cuenta está bajo investigación criminal' o 'Si no realizas esta transferencia confidencial inmediatamente serás despedido'. El estrés inhibe el razonamiento crítico de este perfil. Su Regla de Oro le recuerda que el protocolo de seguridad de la organización es sagrado y neutraliza cualquier presión. Además, si cometes un error (como hacer clic), la ciberresiliencia exige reportarlo de inmediato en lugar de ocultarlo por miedo, ya que el reporte temprano mitiga el 90% del impacto de un virus.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    },
    {
      ...
      "visual_title": "",
      "text_on_screen": [
        "• Tu Riesgo (Arrogancia Cognitiva): La autoconfianza excesiva y la curiosidad. Asumes que eres inmune al engaño, lo que te lleva a saltarte controles de seguridad o usar Shadow AI.",
        "• Comportamiento Típico: Probar software libre en el equipo de la empresa o desactivar alertas de antivirus pensando que entorpecen tu trabajo.",
        "• Tu Regla de Oro: Zero Trust (Cero Confianza). No confíes ciegamente en tus instintos por encima de los sistemas de seguridad de la organización. Incluso los expertos caen."
      ],
      "extended_text": [
        "\"El perfil temerario tiene una alta apertura a la experiencia y una excesiva autoconfianza tecnológica. Al creer que 'sabe de informática', infravalora la sofisticación de los ataques modernos y considera las políticas del departamento de seguridad como trabas burocráticas que ralentizan su productividad. Este perfil tiende a instalar software no autorizado, desactivar los firewalls locales o ignorar los avisos de la empresa sobre Shadow AI. Su Regla de Oro es adoptar el principio de Cero Confianza (Zero Trust): en ciberseguridad, todo elemento y comportamiento debe ser verificado, independientemente de lo experto que se considere el usuario. Nadie es 100% inmune a la ingeniería social generada por IA.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    },
    {
      ...
      "visual_title": "",
      "text_on_screen": [
        "• Tu Riesgo (Oversharing): Compartir demasiada información sobre tu vida laboral en redes sociales corporativas o personales (como fotos en la oficina o detalles de proyectos).",
        "• Comportamiento Típico: Publicar imágenes de acreditaciones, ordenadores abiertos con pantallas de fondo legibles o dar detalles de clientes en redes.",
        "• Tu Regla de Oro: El Escudo de Privacidad. Antes de publicar cualquier foto o información corporativa en redes sociales, analiza si puede ser útil para un atacante."
      ],
      "extended_text": [
        "\"El perfil expuesto cuenta con una alta extraversión y sociabilidad. En internet, esto se manifiesta como 'oversharing' o divulgación excesiva. Los atacantes realizan reconocimiento pasivo (fase 1 de la Cyber Kill Chain) husmeando en perfiles de LinkedIn, Instagram o Facebook de los empleados. Una foto inocente de tu mesa de trabajo puede mostrar contraseñas apuntadas en post-its, el modelo de tu ordenador o un documento confidencial legible. Revelar detalles como 'Viajando a Barcelona para firmar el proyecto X con el cliente Y' da a los atacantes el pretexto perfecto para enviar un email falso simulando ser el cliente Y pidiendo cambios de cuenta bancaria. Proteger el perímetro digital exige mantener la esfera profesional estrictamente separada de las redes públicas.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    },
    {
      ...
      "text_on_screen": [
        "• El Proceso Metódico: Los ciberataques no son instantáneos; siguen un proceso estructurado conocido como Cyber Kill Chain (Cadena de Muerte Cibernética).",
    ...
    {
      "module_id": 2,
      "slide_num_str": "Diapositiva 27B",
      "title": "Ilustración - Ejemplos de Phishing, Smishing y QRshing",
      "visual_title": "Ejemplos visuales de Phishing, Smishing y QRshing",
      "text_on_screen": [],
      "extended_text": [
        "\"Esta ilustración muestra los tres principales vectores de ingeniería social que más crecen en España. El phishing por correo electrónico sigue siendo la puerta de entrada del 91% de los ciberataques corporativos según datos del INCIBE. El smishing (SMS fraudulento) aprovecha la confianza instintiva que depositamos en los mensajes de texto, simulando avisos de paquetería, bancos o servicios públicos. El QRshing es la técnica más reciente: los atacantes sustituyen códigos QR legítimos en restaurantes, parkings o carteles oficiales por otros que redirigen a webs clonadas de robo de credenciales. La lección clave es triple: nunca hagas clic en enlaces de correos inesperados, desconfía de cualquier SMS que solicite acción urgente, y antes de escanear un código QR verifica que no ha sido pegado encima del original.\""
      ],
      "image_desc": "Ejemplos visuales de amenazas móviles y web en un diseño de ciberseguridad. Incluye un correo de phishing en una pantalla de portátil, un mensaje SMS de smishing en un smartphone con un aviso de entrega de paquete falso, y un código QR falso para representar la técnica de QRshing. Estilo de ilustración moderna con tonos oscuros y acentos de color amarillo de advertencia.",
      "image_file": "img_01.jpg",
      "type": "image",
      "is_range": false,
      "layout": null,
      "module_title": "Psicología del Ataque y Shadow AI",
    ...
    {
      "module_id": 2,
      "slide_num_str": "Diapositiva 28B",
      "title": "Ilustración - Clonación de Voz y Deepfakes",
      "visual_title": "Ejemplos de Deepfakes en Vishing y Videollamadas",
      "text_on_screen": [],
      "extended_text": [
        "\"Esta imagen representa las técnicas avanzadas de suplantación mediante Inteligencia Artificial. La clonación de voz permite a los atacantes replicar el tono, cadencia y acento de cualquier persona con solo 3 segundos de audio público (un vídeo en redes sociales es suficiente). En 2024, una empresa multinacional perdió 25 millones de dólares cuando un empleado transfirió fondos tras recibir una videollamada con deepfakes de sus superiores. Los deepfakes de vídeo en tiempo real ya pueden superponer rostros convincentes durante videoconferencias, haciendo que el interlocutor parezca un directivo legítimo. Tu defensa: ante cualquier solicitud urgente de transferencia o información sensible por teléfono o videollamada, aplica el protocolo de verificación fuera de banda. Cuelga y llama tú directamente al número oficial de esa persona para confirmar la petición.\""
      ],
      "image_desc": "Ilustración de alta tecnología que muestra el concepto de clonación de voz y manipulación de rostros (deepfakes). Representa un rostro digitalizado en una pantalla que es escaneado y mapeado mediante nodos de red con líneas de ondas de voz distorsionadas sobre un fondo oscuro con tonos de iluminación de neón púrpura y azul.",
      "image_file": "img_02.jpg",
      "type": "image",
      "is_range": false,
      "layout": null,
      "module_title": "Psicología del Ataque y Shadow AI",
    ...
    },
    {
      ...
      "text_on_screen": [
        "• Definición de Shadow AI: El uso de herramientas de IA Generativa (como ChatGPT, Gemini o Claude) para tareas laborales sin autorización ni supervisión de IT.",
    ...
    },
    {
      ...
      "visual_title": "Resultados del Módulo 2",
      "text_on_screen": [
    ...
    {
      "module_id": 3,
      "slide_num_str": "Diapositiva 3A",
      "title": "Portada del Módulo 3",
      "visual_title": "Protección de Datos 360",
      "text_on_screen": [
        "• Módulo 3: Protección de Datos 360",
        "• RGPD, LOPDGDD y los Derechos ARSOPOL explicados con casos reales"
      ],
      "extended_text": [
        "\"Este módulo aborda el núcleo legal de la privacidad de datos. Aprenderás qué es un dato personal bajo el RGPD, cómo clasificarlo por nivel de riesgo, cuáles son tus deberes como custodio de datos y los poderosos derechos que el ciudadano puede ejercer contra tu empresa. Incluye dos simulacros interactivos.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    },
    {
      ...
      "visual_title": "",
      "text_on_screen": [
        "• Activo Crítico: El dato personal se ha convertido en el activo digital más valioso y protegido del mundo corporativo.",
    ...
    },
    {
      ...
      "text_on_screen": [
        "• Alcance Normativo: Bajo el RGPD y la LOPDGDD, un dato personal abarca mucho más que un simple nombre o número de cuenta.",
    ...
    },
    {
      ...
      "text_on_screen": [
        "• Principio de Proporcionalidad: La normativa exige aplicar medidas de seguridad proporcionales a la sensibilidad de la información manejada.",
    ...
    },
    {
      ...
      "text_on_screen": [
        "• Especial Protección (RGPD Art. 8): Los datos de menores son considerados de alta protección y requieren una tutela jurídica muy estricta por su especial vulnerabilidad.",
        "• Edad de Consentimiento: En España, el menor puede consentir por sí mismo a partir de los 14 años. Por debajo de esta edad, se requiere el consentimiento del tutor legal.",
        "• Principio de Transparencia: Toda información dirigida a un menor debe ser redactada en un lenguaje claro, sencillo y visualmente comprensible para su edad.",
        "• Medidas de Seguridad Clave: Requiere control estricto de accesos, cifrado de archivos, auditorías recurrentes y realizar una Evaluación de Impacto (EIPD)."
      ],
      "extended_text": [
        "\"La información relativa a menores de edad recibe una protección prioritaria en el RGPD y la LOPDGDD. Al considerarse colectivos vulnerables, los menores de edad no son plenamente conscientes de los riesgos, consecuencias y salvaguardas del tratamiento de sus datos personales. En España, la edad mínima para consentir de forma autónoma está fijada en los 14 años. Cualquier recogida de información de menores de 14 años sin la acreditación explícita del consentimiento parental o del tutor constituye una vulneración grave de la ley, sancionada con elevadas multas. Además, si tu puesto de trabajo implica el manejo de datos de menores (por ejemplo, en el sector educativo, sanitario, recursos humanos con datos de beneficiarios, o desarrollo de software infantil), debes redoblar las precauciones. El almacenamiento de estos archivos exige cifrado obligatorio en reposo y en tránsito. Además, es un requisito legal redactar las políticas de privacidad y los consentimientos de forma que un menor pueda comprenderlos de manera autónoma, utilizando esquemas visuales o explicaciones simplificadas si es preciso. Para tratamientos sistemáticos a gran escala, es obligatorio realizar una Evaluación de Impacto de Protección de Datos (EIPD) antes de iniciar cualquier operación.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    {
      "module_id": 3,
      "slide_num_str": "Diapositiva 40B",
      "title": "Simulacro Interactivo - El Clasificador de la Privacidad",
      "visual_title": "El Clasificador RGPD: ¿Qué tipo de dato es este?",
      "text_on_screen": [
        "• Ejercicio: Clasifica cada tipo de dato en la categoría legal correcta según el RGPD y la LOPDGDD.",
        "• Objetivo: Practicar la identificación rápida del nivel de protección legal que requiere cada dato.",
        "• Interacción: Lee el dato que aparece y pulsa el botón de la categoría correcta."
      ],
      "extended_text": [
        "\"Reconocer el nivel de sensibilidad de un dato es la primera línea de defensa legal. Si clasifica erróneamente datos de salud como básicos, puede incurrir en sanciones de hasta 20 millones de euros bajo el RGPD. Este ejercicio entrena tu capacidad de triaje de datos en situaciones reales de tu puesto de trabajo.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    },
    {
      ...
      "text_on_screen": [
        ...
        "• Deber de Confidencialidad: Garantizar que los datos no sean revelados ni accesibles a personas no autorizadas.",
        ...
        "• Reporte Obligatorio (Ley 2/2023): Si detectas que un compañero o superior vulnera la confidencialidad, debes usar el Canal de Denuncias interno."
      ],
      "extended_text": [
    ...
    },
    {
      ...
      "text_on_screen": [
        "El segundo eje de la seguridad de la información es la conservación del estado original de los datos:",
        "• Deber de Integridad: Proteger la información contra alteraciones, modificaciones o destrucciones no autorizadas (accidentales o intencionadas).",
        "• Shadow IT Prohibido: Guardar datos de la empresa en dispositivos USB personales no cifrados o nubes privadas destruye la integridad del sistema."
      ],
      "extended_text": [
    ...
    },
    {
      ...
      "text_on_screen": [
        "• Deber de Disponibilidad: Asegurar que la información esté plenamente accesible y utilizable por las personas autorizadas cuando la necesiten.",
        "• El Secuestro de Disponibilidad: Un ataque de Ransomware cifra los archivos para extorsionar a la empresa paralizando por completo su operatividad.",
        "• El Factor Humano: Perder una contraseña de acceso o borrar una carpeta departamental por error es una brecha legal de seguridad."
      ],
      "extended_text": [
    ...
    {
      "module_id": 3,
      "slide_num_str": "Diapositiva 46B",
      "title": "Ilustración - Riesgos de la Supresión Directa",
      "visual_title": "Alertas y advertencias en el borrado de datos",
      "text_on_screen": [],
      "extended_text": [
        "\"Esta ilustración representa un escenario crítico: cuando un ciudadano ejerce su derecho de supresión (el 'derecho al olvido'), el sistema debe activar múltiples comprobaciones antes de borrar cualquier dato. La Ley General Tributaria exige conservar facturas y datos fiscales durante 4 años. La normativa laboral obliga a mantener registros de nóminas y contratos por 4 años tras el fin de la relación laboral. La Ley de Prevención del Blanqueo de Capitales requiere conservar datos de identificación del cliente durante 10 años. Si un empleado borra datos de un cliente sin verificar estos plazos, la empresa se expone a sanciones por destrucción de pruebas fiscales, laborales o penales. La lección es clara: nunca borres datos por tu cuenta. Toda solicitud de supresión debe canalizarse a través del DPO, quien evaluará si existen obligaciones legales que impidan el borrado inmediato.\""
      ],
      "image_desc": "Ilustración conceptual que muestra una pantalla de panel de administración de seguridad de datos con múltiples avisos y alertas críticas de riesgo (símbolos de advertencia, escudos y ventanas emergentes rojas y naranjas indicando 'Danger' o 'Risk'). Estilo de interfaz tecnológica y moderno en modo oscuro.",
      "image_file": "img_03.jpg",
      "type": "image",
      "is_range": false,
      "layout": null,
      "module_title": "Protección de Datos 360",
    ...
    {
      "module_id": 3,
      "slide_num_str": "Diapositiva 46C",
      "title": "Simulacro Interactivo - El Dilema del Derecho al Olvido",
      "visual_title": "El Dilema: Borrar o Conservar",
      "text_on_screen": [
        "• Escenario: Un cliente furioso llama exigiendo que elimines todos sus datos de inmediato amparándose en el RGPD.",
        "• Tu misión: Para cada registro en la base de datos, decide si debes BORRAR o BLOQUEAR/CONSERVAR y ajusta los años de retención legal obligatoria.",
        "• Regla de oro: Nunca ejecutes una supresión sin consultar al DPO. Las obligaciones fiscales y laborales prevalecen sobre el derecho al olvido."
      ],
      "extended_text": [
        "\"El Derecho al Olvido (Art. 17 RGPD) no es absoluto. Existen obligaciones legales tributarias (4 años), laborales (4 años) y de prevención de blanqueo (10 años) que el ciudadano no puede cancelar unilateralmente. El DPO evalúa caso por caso qué datos pueden borrarse y cuáles deben bloquearse para cumplimiento legal. Este ejercicio entrena la toma de decisiones correcta bajo presión.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    {
      "module_id": 4,
      "slide_num_str": "Diapositiva 4A",
      "title": "Portada del Módulo 4",
      "visual_title": "Seguridad en el Entorno Híbrido",
      "text_on_screen": [
        "• Módulo 4: Seguridad en el Entorno Híbrido",
        "• El teletrabajo y cómo proteger tu red doméstica como si fuera la red corporativa"
      ],
      "extended_text": [
        "\"El perímetro de la empresa ya no existe. En este módulo aprenderás a gestionar la seguridad en el teletrabajo, a segmentar tu red doméstica, a usar la VPN correctamente y a evitar que el Shadow IT y los dispositivos IoT de tu hogar se conviertan en la puerta trasera de la organización.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    {
      "module_id": 4,
      "slide_num_str": "Diapositiva 55B",
      "title": "Ilustración - Mesa Limpia frente a Mesa Vulnerable",
      "visual_title": "Comparativa de Buenas y Malas Prácticas en el Espacio Físico",
      "text_on_screen": [],
      "extended_text": [
        "\"Esta imagen compara dos realidades opuestas que conviven en muchas oficinas. A la izquierda, un espacio de trabajo que cumple la política de mesa limpia exigida por la norma ISO 27001 y el Esquema Nacional de Seguridad: portátil cerrado con cable de seguridad Kensington, ausencia de documentos impresos y pantalla bloqueada. A la derecha, las vulnerabilidades más comunes: contraseñas anotadas en notas adhesivas visibles, memorias USB sin cifrar abandonadas sobre la mesa, y documentos impresos con datos personales de clientes a la vista de cualquier visitante. Según la AEPD, el 23% de las brechas de datos en España se originan por negligencia física, no por ataques informáticos. Cada vez que te levantes de tu puesto, aplica la regla Win+L (bloqueo de sesión), guarda los documentos bajo llave y nunca dejes dispositivos USB o móviles desatendidos. La seguridad física es tan importante como la digital.\""
      ],
      "image_desc": "Ilustración comparativa dividida en dos. A la izquierda: un espacio de trabajo seguro (escritorio limpio, portátil cerrado con candado de seguridad, sin papeles). A la derecha: un escritorio vulnerable (contraseñas escritas en notas adhesivas pegadas a la pantalla, memorias USB expuestas sobre la mesa, documentos impresos con datos sensibles visibles). Ilustración moderna con tonos limpios en el lado seguro y advertencias en rojo en el lado vulnerable.",
      "image_file": "img_04.jpg",
      "type": "image",
      "is_range": false,
      "layout": null,
      "module_title": "Seguridad en el Entorno Híbrido",
    ...
    },
    {
      ...
      "text_on_screen": [
        "• El Túnel Seguro (VPN): Herramienta obligatoria para el teletrabajo. Cifra toda la información para evitar intercepciones.",
        "• Seguridad del Router: Cambia la contraseña de administración por defecto y asegura que tu red Wi-Fi use un protocolo robusto (WPA3 o WPA2).",
        "• Prohibición de Desconexión: Está prohibido desactivar la VPN corporativa para \"navegar más rápido\". Esto viola las directrices de ciberseguridad corporativas."
      ],
      "extended_text": [
    ...
    {
      "module_id": 4,
      "slide_num_str": "Diapositiva 56B",
      "title": "Ilustración - Funcionamiento de la VPN",
      "visual_title": "Esquema del Túnel Seguro de Conexión",
      "text_on_screen": [],
      "extended_text": [
        "\"Esta ilustración visualiza el funcionamiento de una VPN corporativa, herramienta obligatoria para todo trabajador en remoto. Cuando te conectas desde casa o una cafetería, tus datos viajan por redes que la empresa no controla. Sin VPN, un atacante en la misma red Wi-Fi puede ejecutar un ataque Man-in-the-Middle e interceptar correos, contraseñas y documentos en tránsito. La VPN crea un túnel cifrado punto a punto: toda la información se encapsula en un protocolo seguro (como IPsec o WireGuard) que la hace ilegible para cualquier observador externo. El Esquema Nacional de Seguridad (ENS) prohíbe expresamente acceder a información de la Administración sin este tipo de conexión protegida. Recuerda: desactivar la VPN para 'navegar más rápido' está terminantemente prohibido y constituye una infracción grave de la política de seguridad corporativa.\""
      ],
      "image_desc": "Ilustración de un túnel digital que atraviesa un espacio abierto peligroso entre un hogar y el servidor de la empresa. El túnel está representado con un efecto de malla de seguridad o cadena de bloques, protegiendo los datos que viajan por su interior frente a amenazas externas representadas con rayos y ojos espías.",
      "image_file": "img_05_b.jpg",
      "type": "image",
      "is_range": false,
      "layout": null,
      "module_title": "Seguridad en el Entorno Híbrido",
    ...
    {
      "module_id": 4,
      "slide_num_str": "Diapositiva 59B",
      "title": "Ilustración - El peligro del Shadow IT",
      "visual_title": "Representación de servicios no autorizados",
      "text_on_screen": [],
      "extended_text": [
        "\"Esta ilustración representa el fenómeno del Shadow IT: el uso de herramientas tecnológicas (almacenamiento en la nube, apps de mensajería, editores online) sin la autorización ni supervisión del departamento de IT. Según Gartner, entre el 30% y el 40% del gasto tecnológico en grandes empresas corresponde a Shadow IT. El peligro no es solo técnico, sino legal: cuando un empleado sube un contrato confidencial a su Google Drive personal o comparte datos de clientes por WhatsApp, esos datos abandonan el perímetro seguro de la empresa. Si esa información se filtra, la empresa no podrá demostrar ante la AEPD que aplicó las medidas de seguridad exigidas por el RGPD, ya que desconocía dónde estaban almacenados los datos. La lección: utiliza exclusivamente las herramientas aprobadas por IT. Si necesitas una funcionalidad que no tienes, solicítala formalmente. Nunca busques atajos tecnológicos con tus propias cuentas personales.\""
      ],
      "image_desc": "Una red de dispositivos que se conectan de forma caótica a servicios fuera del círculo corporativo (representado como una zona segura). Iconos de nubes de almacenamiento y herramientas online brillantes conectadas a archivos corporativos sensibles con líneas rojas de alerta.",
      "image_file": "img_05_c.jpg",
      "type": "image",
      "is_range": false,
      "layout": null,
      "module_title": "Seguridad en el Entorno Híbrido",
    ...
    },
    {
      ...
      "text_on_screen": [
        "• Riesgo de llevar la oficina en el bolsillo: Si configuras el correo corporativo o aplicaciones de la empresa en tu teléfono personal, este dispositivo se convierte en un activo auditable.",
    ...
    {
      "module_id": 5,
      "slide_num_str": "Diapositiva 5A",
      "title": "Portada del Módulo 5",
      "visual_title": "Protocolo de Respuesta ante Incidentes",
      "text_on_screen": [
        "• Módulo 5: Protocolo de Respuesta ante Incidentes",
        "• La Regla de Oro y qué hacer en los primeros 5 minutos de un ataque"
      ],
      "extended_text": [
        "\"El riesgo cero no existe. En este módulo aprenderás a reconocer los síntomas de un ciberataque en tiempo real, a ejecutar el protocolo de reacción de 4 pasos (calma, aislamiento, no apagar, comunicar) y a comprender la importancia de preservar la cadena de custodia digital para la investigación forense posterior.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    },
    {
      ...
      "visual_title": "",
      "text_on_screen": [
        "• La Regla de Oro: La detección temprana es lo único que salva la infraestructura de la empresa.",
        "• El Factor Tiempo: En ciberseguridad, el tiempo no es dinero; el tiempo es supervivencia.",
        "• Exigencia Legal (NIS2/ENS): Las normativas exigen disponer de protocolos rápidos, claros y auditables de respuesta.",
        "• Tu Objetivo Clave: Identificar anomalías y reportar en los primeros 5 minutos para frenar la propagación."
      ],
      "extended_text": [
    ...
    },
    {
      ...
      "text_on_screen": [
        "• Paso 1. Mantener la calma: El pánico lleva a tomar decisiones impulsivas. No intentes arreglar el problema solo. Prohibido consultar IAs públicas (Shadow AI) introduciendo código o datos corporativos.",
        "• Paso 2. Desconexión de Red Inmediata: Si sospechas de un compromiso, corta la conexión de internet de inmediato desconectando físicamente el cable Ethernet y apagando el Wi-Fi."
      ],
      "extended_text": [
    ...
    {
      "module_id": 5,
      "slide_num_str": "Diapositiva 70B",
      "title": "Ilustración - Desconexión Física de Red",
      "visual_title": "Medida de Contención Inmediata: Cable RJ45",
      "text_on_screen": [],
      "extended_text": [
        "\"Esta ilustración muestra la primera acción que todo empleado debe ejecutar ante una sospecha de ciberataque: la desconexión física de red. Al retirar el cable Ethernet RJ45 del equipo o desactivar el Wi-Fi, se corta inmediatamente la comunicación entre el malware instalado en tu ordenador y su servidor de comando y control (C2). Esta acción cumple dos funciones vitales: primero, impide que el atacante siga extrayendo datos de tu equipo; segundo, bloquea la propagación lateral del ransomware a otros ordenadores de la red corporativa. Un ransomware puede cifrar toda una red empresarial en menos de 45 minutos si no se aísla a tiempo. Recuerda: no apagues el equipo (perderías evidencias forenses), simplemente desconecta el cable de red y avisa inmediatamente al equipo de IT o al CSIRT.\""
      ],
      "image_desc": "Primer plano de una mano desconectando un cable de red Ethernet RJ45 azul de un conector brillante en un panel de red o puerto de ordenador. Fondo tecnológico oscuro con trazos de luz que representan la interrupción inmediata del flujo de datos.",
      "image_file": "img_05.jpg",
      "type": "image",
      "is_range": false,
      "layout": null,
      "module_title": "Protocolo de Respuesta ante Incidentes",
    ...
    },
    {
      ...
      "text_on_screen": [
        "• Validez de Pruebas (RD-ley 6/2023): Según el Decreto Ómnibus, las pruebas digitales tienen validez jurídica en un juicio si no han sido manipuladas.",
    ...
    {
      "module_id": 5,
      "slide_num_str": "Diapositiva 71B",
      "title": "Ilustración - Cadena de Custodia Digital",
      "visual_title": "Preservación de la evidencia forense",
      "text_on_screen": [],
      "extended_text": [
        "\"Esta imagen ilustra el concepto legal de la Cadena de Custodia Digital, regulada por el Real Decreto-ley 6/2023. Cuando se produce un ciberataque, el equipo infectado contiene pruebas forenses de valor incalculable: logs de acceso, archivos temporales, registros de conexión y metadatos que permiten rastrear al atacante. Si un empleado, asustado por su error, intenta borrar su historial de navegación, eliminar correos sospechosos o reinstalar el sistema operativo, estará destruyendo pruebas que podrían ser decisivas en un juicio o en la reclamación del seguro de ciberriesgos. Una evidencia digital manipulada pierde automáticamente su validez jurídica. La regla de oro es simple: ante un incidente, aparta las manos del teclado, no apagues ni reinicies el equipo, y llama inmediatamente al equipo de respuesta. Deja que los peritos forenses extraigan y preserven las pruebas de forma profesional.\""
      ],
      "image_desc": "Representación gráfica de un dispositivo móvil o portátil dentro de una bolsa de pruebas forenses transparente, rodeado de nodos de red que muestran la integridad de la prueba. Estilo minimalista y serio, enfocado en el cumplimiento normativo.",
      "image_file": "img_05_d.jpg",
      "type": "image",
      "is_range": false,
      "layout": null,
      "module_title": "Protocolo de Respuesta ante Incidentes",
    ...
    },
    {
      ...
      "text_on_screen": [
        ...
        "• El Riesgo Legal: Las filtraciones dañan gravísimamente la reputación de la empresa y pueden desencadenar responsabilidades y pánico en los clientes."
      ],
      "extended_text": [
    ...
    },
    {
      ...
      "text_on_screen": [
        ...
        "• La No Ocultación: Ocultar un error agrava el daño; reportarlo de inmediato nos permite solucionarlo eficazmente.",
    ...
    {
      "module_id": 6,
      "slide_num_str": "Diapositiva 6A",
      "title": "Portada del Módulo 6",
      "visual_title": "Salud Mental y Ética Digital",
      "text_on_screen": [
        "• Módulo 6: Salud Mental y Ética Digital",
        "• Desconexión digital, tecnoestrés y la cultura de 'No Culpa'"
      ],
      "extended_text": [
        "\"La ciberseguridad tiene una dimensión humana frecuentemente olvidada. En este módulo exploraremos el tecnoestrés, el síndrome de fatiga digital y los riesgos psicosociales de la hiperconectividad. También aprenderás por qué una cultura organizativa de 'No Culpa' es la estrategia de seguridad más efectiva para que los empleados reporten incidentes sin miedo.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    {
      "module_id": 6,
      "slide_num_str": "Diapositiva 82_IMG",
      "title": "Ilustración - Tecnoestrés y Notificaciones",
      "visual_title": "El Impacto del Tecnoestrés en la Ciberhigiene",
      "text_on_screen": [],
      "extended_text": [
        "\"Esta ilustración muestra el impacto real del tecnoestrés en la ciberseguridad corporativa. Un trabajador sometido a un flujo constante de notificaciones (correos, alertas de aplicaciones, mensajes instantáneos, llamadas) experimenta una sobrecarga cognitiva que reduce drásticamente su capacidad de juicio. Estudios del Instituto Nacional de Seguridad y Salud en el Trabajo (INSST) demuestran que la fatiga por alertas incrementa un 400% la probabilidad de hacer clic en un enlace malicioso. El cerebro agotado activa respuestas automáticas: abre adjuntos sin verificar, acepta permisos sin leer y aprueba solicitudes sin cuestionar. Esta fatiga digital no es un signo de incompetencia sino una respuesta fisiológica a la hiperconectividad. La empresa debe facilitar períodos de desconexión parcial, silenciar notificaciones no críticas y formar a los equipos para reconocer cuándo su nivel de atención está comprometido.\""
      ],
      "image_desc": "Ilustración de un empleado abrumado en su escritorio, rodeado de una nube de iconos de notificaciones flotantes, alertas de correo, llamadas y signos de exclamación en rojo y rosa de neón. El fondo es oscuro para enfatizar el estado de sobrecarga mental y tecnoestrés.",
      "image_file": "img_06.jpg",
      "type": "image",
      "is_range": false,
      "layout": null,
      "module_title": "Salud Mental y Ética Digital",
    ...
    },
    {
      ...
      "visual_title": "Derecho a la Desconexión Digital (Art. 88) y Ley 2/2023",
      "text_on_screen": [
    ...
    {
      "module_id": 6,
      "slide_num_str": "Diapositiva 85B",
      "title": "Ilustración - El Equilibrio de la Desconexión Digital",
      "visual_title": "El Respeto al Descanso y la Recuperación Mental",
      "text_on_screen": [],
      "extended_text": [
        "\"Esta ilustración simboliza el derecho a la desconexión digital, reconocido por la LOPDGDD (Art. 88) y el Estatuto de los Trabajadores. La neurociencia ha demostrado que el descanso cognitivo no es un lujo sino una necesidad biológica: tras 8 horas de exposición continua a pantallas, la capacidad de detección de anomalías (como un correo de phishing) disminuye hasta un 70%. Un empleado descansado es un empleado ciberresiliente. El descanso permite al cerebro consolidar los aprendizajes de seguridad y restablecer los mecanismos de alerta natural. La empresa tiene la obligación legal de garantizar que fuera del horario laboral no se envíen comunicaciones que exijan respuesta, salvo en situaciones de emergencia tasadas (como un incidente de seguridad crítico). Respetar tu descanso es proteger la seguridad de toda la organización.\""
      ],
      "image_desc": "Ilustración minimalista y relajante de un botón de apagado o desconexión digital de neón suave que se integra en un paisaje natural de hojas verdes y suaves ondas ecológicas sobre un fondo oscuro, transmitiendo paz, desconexión de pantallas y descanso saludable.",
      "image_file": "img_07.jpg",
      "type": "image",
      "is_range": false,
      "layout": null,
      "module_title": "Salud Mental y Ética Digital",
    ...
    },
    {
      ...
      "text_on_screen": [
        ...
        "• Protocolo de Compensación: Estas situaciones excepcionales deben estar reguladas y contar con compensaciones justas para proteger tu descanso."
      ],
      "extended_text": [
    ...
    {
      "module_id": 7,
      "slide_num_str": "Diapositiva 7A",
      "title": "Portada del Módulo 7",
      "visual_title": "Gestión de Vulnerabilidades y Brechas",
      "text_on_screen": [
        "• Módulo 7: Gestión de Vulnerabilidades y Brechas",
        "• El límite operativo, el protocolo de las 72 horas y la gestión legal de la crisis"
      ],
      "extended_text": [
        "\"Ningún sistema es 100% invulnerable. En este módulo aprenderás a distinguir entre vulnerabilidad y brecha de datos, cómo priorizar amenazas en el límite operativo, qué hacer legalmente en las 72 horas críticas tras una brecha y a qué agencias nacionales debes notificar. Incluye dos simulacros interactivos.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    {
      "module_id": 7,
      "slide_num_str": "Diapositiva 97B",
      "title": "Simulacro Interactivo - ¿Vulnerabilidad o Brecha?",
      "visual_title": "Triador de Incidentes: ¿Vulnerabilidad o Brecha de Datos?",
      "text_on_screen": [
        "• Ejercicio: Para cada incidente de seguridad, clasifícalo, evalúa su impacto y activa las notificaciones legales correctas.",
        "• Objetivo: Aplicar la distinción legal entre vulnerabilidad y brecha, y decidir a quién notificar en cada caso.",
        "• Interacción: Usa los botones, sliders e interruptores para cada uno de los 3 escenarios y pulsa Evaluar cuando hayas completado los tres."
      ],
      "extended_text": [
        "\"El coste de confundir una vulnerabilidad con una brecha puede ser catastrófico en ambas direcciones: no notificar una brecha real supone multas de hasta 10M€ por incumplimiento del Art. 33 RGPD, mientras que declarar una vulnerabilidad menor como brecha genera alarma innecesaria y daño reputacional. Este ejercicio entrena el criterio de triaje legal que necesitas para proteger a tu organización.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
    ...
    {
      "module_id": 7,
      "slide_num_str": "Diapositiva 99B",
      "title": "Ilustración - Canal de Denuncias Anónimo",
      "visual_title": "Seguridad y protección del informante",
      "text_on_screen": [],
      "extended_text": [
        "\"Esta imagen representa el Canal Interno de Información regulado por la Ley 2/2023, de protección del informante (transposición de la Directiva Whistleblowing de la UE). Toda empresa con más de 50 trabajadores está obligada a disponer de un canal seguro, confidencial y accesible para que los empleados puedan denunciar irregularidades sin temor a represalias. En el contexto de la ciberseguridad, este canal es esencial para reportar situaciones como: un compañero que comparte contraseñas, un superior que ordena saltarse protocolos de seguridad, o la detección de software no autorizado en equipos corporativos. La Ley prohíbe expresamente cualquier forma de represalia (despido, cambio de puesto, acoso) contra el informante de buena fe. La protección es tanto anónima como legal: la identidad del denunciante solo puede ser revelada con su consentimiento o por orden judicial.\""
      ],
      "image_desc": "Ilustración de un conducto o túnel seguro de comunicación con un candado de seguridad, representando el anonimato y la protección legal. Diseño limpio con tonos de seguridad (verde, blanco y gris) que evoca confianza y confidencialidad en el proceso de reporte de irregularidades.",
      "image_file": "img_07_b.jpg",
      "type": "image",
      "is_range": false,
      "layout": null,
      "module_title": "Gestión de Vulnerabilidades y Brechas",
    ...
    {
      "module_id": 7,
      "slide_num_str": "Diapositiva 100B",
      "title": "Ilustración - Triaje ante Brechas",
      "visual_title": "Proceso de contención y clasificación del impacto",
      "text_on_screen": [],
      "extended_text": [
        "\"Esta imagen ilustra el proceso de triaje ante una brecha de datos, el momento más crítico de la respuesta. El triaje consiste en clasificar rápidamente el impacto del incidente en cuatro niveles: Bajo (datos no sensibles de pocos usuarios), Medio (datos personales básicos), Alto (datos financieros o de salud) y Crítico (datos de categoría especial a gran escala). Esta clasificación determina las acciones inmediatas: qué sistemas aislar, a quién convocar al Comité de Crisis, y si es necesario activar el protocolo ENS por afectar a servicios de la Administración Pública. El DPO lidera la evaluación legal mientras el equipo técnico ejecuta la contención. Un triaje mal ejecutado (por ejemplo, subestimar el impacto para evitar la notificación a la AEPD) constituye una infracción agravante que multiplica las sanciones económicas.\""
      ],
      "image_desc": "Un centro de control con múltiples monitores visualizando una red de datos en crisis. Se observan flujos de información hacia fuera del perímetro y ventanas de triaje con niveles de riesgo (Bajo, Medio, Alto, Crítico) claramente marcados.",
      "image_file": "img_07_c.jpg",
      "type": "image",
      "is_range": false,
      "layout": null,
      "module_title": "Gestión de Vulnerabilidades y Brechas",
    ...
    {
      "module_id": 7,
      "slide_num_str": "Diapositiva 101_IMG",
      "title": "Ilustración - El Cronómetro de las 72 Horas",
      "visual_title": "El Tiempo Límite Legal para la Notificación",
      "text_on_screen": [],
      "extended_text": [
        "\"Esta ilustración simboliza el plazo legal más importante en la gestión de brechas de datos: las 72 horas del Artículo 33 del RGPD. Desde el momento exacto en que la empresa tiene constancia cierta de una brecha (no cuando la descubre IT, sino cuando cualquier empleado la detecta), comienza una cuenta atrás implacable. Este plazo no se suspende en fines de semana, festivos ni vacaciones. La notificación a la AEPD debe incluir: la naturaleza de la brecha, las categorías y número aproximado de afectados, los datos de contacto del DPO, las consecuencias probables y las medidas adoptadas para mitigar el daño. Si se supera el plazo de 72 horas sin justificación documentada, la AEPD puede imponer sanciones de hasta 10 millones de euros o el 2% de la facturación anual global. El mensaje es claro: reporta rápido, reporta completo, nunca ocultes un incidente.\""
      ],
      "image_desc": "Ilustración de un reloj de arena digital brillante relleno de arena de neón púrpura, rodeado por un aro giratorio con una cuenta atrás de 72 horas en formato HUD tecnológico. Estilo de interfaz de seguridad de crisis sobre fondo azul oscuro.",
      "image_file": "img_08.jpg",
      "type": "image",
      "is_range": false,
      "layout": null,
      "module_title": "Gestión de Vulnerabilidades y Brechas",
    ...
    },
    {
      ...
      "text_on_screen": [
        ...
        "• Contenido de la Notificación: Debe incluir la naturaleza de la brecha, volumen de datos afectados, datos de contacto del DPO, y las posibles consecuencias junto con las medidas correctivas."
      ],
      "extended_text": [
    ...
    {
      "module_id": 7,
      "slide_num_str": "Diapositiva 101B",
      "title": "Simulacro Interactivo - La Cuenta Atrás de las 72 Horas",
      "visual_title": "El Protocolo Legal: Ordena las 72 Horas Críticas",
      "text_on_screen": [
        "• Escenario: Se ha confirmado una brecha de datos. El cronómetro legal del Art. 33 RGPD acaba de empezar.",
        "• Tu misión: Ordena las 5 acciones legales críticas en la secuencia correcta haciendo clic en ellas del paso 1 al 5.",
        "• Atención: Si la notificación a la AEPD llega después de las 72 horas, la multa es automática."
      ],
      "extended_text": [
        "\"El Art. 33 del RGPD y la LOPDGDD son taxativos: el reloj de 72 horas empieza cuando cualquier empleado de la empresa tiene constancia del incidente, no cuando lo confirma el departamento técnico. Por ello, la cadena de acciones debe ser ejecutada con precisión y sin dilación: aislar primero, evaluar el impacto después, redactar el informe, notificar a la AEPD y, si el riesgo es alto, avisar a los afectados. Cada minuto de retraso injustificado agrava la sanción.\""
      ],
      "image_desc": null,
      "image_file": null,
      "type": "content",
